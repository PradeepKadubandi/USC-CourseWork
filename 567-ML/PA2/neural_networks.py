...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        ###############################################################################################
        self.params['W'] = np.random.normal(0.0, 0.1, (input_D, output_D))
        self.params['b'] = np.random.normal(0.0, 0.1, (1, output_D))
        ...
        ###############################################################################################
        self.gradient['W'] = np.zeros_like(self.params['W'])
        self.gradient['b'] = np.zeros_like(self.params['b'])
...
class relu:
    ...
    def forward(self, X):
        ...
        self.mask = np.array(X > 0, dtype=int)
        return forward_output
...
class tanh:
    ...
    def backward(self, X, grad):
        ...
        ####################################################################################################
        backward_output = grad * (1.0 - (np.tanh(X) ** 2))
        return backward_output
